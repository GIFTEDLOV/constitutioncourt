# deploy/bradbury/case-003/

Resumable pilot record for **case-003**. Written by `python -m pilot run case-003`.
...
```bash
CONSTITUTIONCOURT_LIVE=1 CONSTITUTIONCOURT_ALLOW_WRITES=1 CONSTITUTIONCOURT_RESUME=1 python -m pilot resume case-003
```
